 ...
 */
function boots_build_preprocess_environment(&$vars) {
 ...
 * @param $vars
 */
function boots_build_preprocess_node_task(&$vars) {
 ...
 * @param $vars
 */
function boots_build_preprocess_node_project(&$vars){
  global $user;
 ...
 */
function boots_build_form_project_node_form_alter(&$form, &$form_state, $form_id) {
